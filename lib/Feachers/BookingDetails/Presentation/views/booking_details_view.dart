...
import '../../../../Core/utils/component.dart';
import '../../../../Core/utils/constant.dart';
import '../../Data/models/ClinicAppointmentDetailsModel.dart';
...
class BookingDetailsView extends StatefulWidget {
  ...
  BookingDetailsView({this.isAdditionalFromSoeCiArea = false});
...
class _BookingDetailsViewState extends State<BookingDetailsView> {
  ...
  await  SpecialtiesCubit.get(context).fetchMyClinicsAppointment();
  ...
  Future<void> _refresh() async {
    ...
    SpecialtiesCubit.get(context).fetchMyAppointment();
    SpecialtiesCubit.get(context).fetchMyClinicsAppointment();
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: DoctorCardDetailsSpesific(
                                ...
                                specialty: context.locale.languageCode == 'ar'
                                    ...
                                    : '${cubit.doctorDetailsModel!.specializations![0].nameEn} ',
                                imageUrl:
                                    '${cubit.myAppointMentModel!.doctor!.img}',
                                rating: double.parse(
                                    cubit.doctorDetailsModel!.averageRating ??
                                        "-1"),
                                reviewCount: int.parse(cubit
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  cubit.myAppointMentModel!.appointments!
                                          .isEmpty
                                      ? SizedBox()
                                      : Text(
                                          'Select Date'.tr(),
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.symmetric(horizontal: 20.0),
                              child: cubit
                                      .myAppointMentModel!.appointments!.isEmpty
                                  ? SizedBox()
                                  : Text(
                                      'Available time'.tr(),
                                      style: Theme.of(context)
                            ...
                            Padding(
                              ...
                              child: cubit
                                  ...
                                  : GridView.builder(
                                      ...
                                      gridDelegate:
                                          SliverGridDelegateWithFixedCrossAxisCount(
                                        crossAxisCount: cubit.myAppointMentModel!
                                            .is_entry_is_first_come_first_served! ? 2:3,
                                        childAspectRatio: 2.73,
                                        crossAxisSpacing: 10,
                                        mainAxisSpacing: 20,
                                      ),
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        if (cubit.myAppointMentModel!
                                         ...
                                         /* final appointment = cubit
                                          ...
                                          // Handle first-come-first-served case
                                          final appointment = cubit.availableAppointmentsForSelectedDate()[index];
                                          DateTime fromTime = DateTime.parse('${appointment.date!} ${appointment.from!}');
                                          DateTime toTime = DateTime.parse('${appointment.date!} ${appointment.to!}');

                                          // Formatting time based on locale
                                          if (itArabic) {
                                            time = '${DateFormat('hh:mm a', 'ar_SA').format(fromTime)} - ${DateFormat('hh:mm a', 'ar_SA').format(toTime)}';
                                          } else {
                                            time = '${DateFormat('hh:mm a', 'en_US').format(fromTime)} - ${DateFormat('hh:mm a', 'en_US').format(toTime)}';
                                          }

                                          isActive = appointment.isActive == "1";
                                          cubit.avariableTimeIds.add(appointment.id!);
                            ...
                            child: BackdropFilter(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () {
                                      navigateTo(context, LoginView(isAdditionalFromSoeCiArea: widget.isAdditionalFromSoeCiArea,));
                                    },
                                    style: ElevatedButton.styleFrom(
                                      primary: Colors.transparent,
                                      onPrimary: Colors.white,
...
/*class ClinicSelection extends StatefulWidget {
  @override
  _ClinicSelectionState createState() => _ClinicSelectionState();
}

class _ClinicSelectionState extends State<ClinicSelection> {
  int _selectedIndex = 0; // Tracks the selected item index

  final List<String> _options = ["Dokki", "Nasr City", "Nasr City"]; // Labels for grid items

  @override
  Widget build(BuildContext context) {
    return GridView.builder(
      shrinkWrap: true, // Takes only the required space
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          key: ValueKey(_options[index]), // Unique key for each item
          onTap: () {
            setState(() {
          ...
          child: Container(
            ...
            child: Text(
              _options[index],
              style: TextStyle(
                color: isSelected ? Colors.white : Color(0xFF7B7D82),
                fontSize: 14,
...
class ClinicSelection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var cubit = SpecialtiesCubit.get(context);
    List<EnterpriseClinic> clinics = cubit.myEnterprises;

    // Handle empty clinics list
    if (clinics.isEmpty) {
      return Center(
        child: Text(
          'No clinics available'.tr(),
          style: TextStyle(
            color: HexColor('#7B7D82'),
            fontSize: itArabic ? 16 : 14,
          ),
        ),
      );
    }
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final clinicName = itArabic ? clinic.nameAr : clinic.nameEn;

        return GestureDetector(
          key: ValueKey(clinic.id), // Unique key for each item
          onTap: () {
          ...
          child: Container(
            ...
            child: Text(
              ...
              style: TextStyle(
                color: isSelected ? Colors.white : HexColor('#7B7D82'),
                fontSize: 14,
                fontWeight: isSelected ? FontWeight.bold : FontWeight.normal,
              ),
            ),
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          ...
          onTap: () {
            ...
            // Optionally, inform cubit about the selected clinic
            cubit.selectClinic(clinic); // Implement this method in your cubit
          },
          child: Container(
            alignment: Alignment.center,
            decoration: BoxDecoration(
