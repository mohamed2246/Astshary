...
import 'package:astshary/Feachers/DoctorDetailsScreen/Presentation/views/widgets/DoctorVediosList.dart';
...
class DoctorDetailsView extends StatefulWidget {
  ...
  DoctorDetailsView({this.isAdditionalFromSoeCiArea = false});
...
class _DoctorDetailsViewState extends State<DoctorDetailsView> {
  ...
  Future<void> _refresh() async {
   ...
   await SpecialtiesCubit.get(context).fetchDoctorDetails();
    SpecialtiesCubit.get(context).fetchAllReviews(SpecialtiesCubit.get(context).doctorDetailsModel!.id);
          ...
          body: cubit.isDoctorDetailsLoading
              ...
              : Stack(
                  children: [
                          ...
                          Expanded(
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Text(
                                                  '${cubit.doctorDetailsModel!.price![cubit.selectedBranchDoctorDetailsIndex].price}',
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .headline5!
                                                      .copyWith(
                                      ...
                                      children: [
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              SvgPicture.network(
                                                  widget.isAdditionalFromSoeCiArea?  cubit.doctorDetailsModel!
                                                      .additional_specializations![0].icon:
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Text(
                                                      ...
                                                      widget.isAdditionalFromSoeCiArea?'${cubit.doctorDetailsModel!.additional_specializations![0].nameAr.toString()}' :'${cubit.doctorDetailsModel!.specializations![0].nameAr.toString()}'
                                                          : widget.isAdditionalFromSoeCiArea?'${formatText(cubit.doctorDetailsModel!.additional_specializations![0].nameEn.toString())}' : '${formatText(cubit.doctorDetailsModel!.specializations![0].nameEn.toString())}',
                                                      style: Theme.of(context)
                                                          .textTheme
                                                          .headline5!
                                                          .copyWith(
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Text(
                                                  '${cubit.doctorDetailsModel!.waitingTime![cubit.selectedBranchDoctorDetailsIndex].waitingTime.toString()}',
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .headline5!
                                                      .copyWith(
                            ...
                            InkWell(
                              onTap: () {
                                ...
                                navigateTo(context, ClinicDetailsView(isAdditionalFromSoeCiArea: widget.isAdditionalFromSoeCiArea));
                              },
                              child: Container(
                                child: Padding(
                                  padding:
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  _buildTabItem(1, 'Reviews'.tr()),
                                  _buildTabItem(2, 'Videos'.tr()),
                                ],
                              ),
                            ),
                            ...
                            if(_selectedIndex == 0)...[
                              Column(
                                ...
                                : Column(
                                  ...
                                  cubit.doctorDetailsModel!.insurances![0].insurances!.isEmpty
                                      ? SizedBox()
                                      : Column(
                                    children: [
                                      Divider(
                            ...
                            if(_selectedIndex == 1)...[
                              ReviewsScreen(cubit.doctorDetailsModel!.id)
                            ],
                            if(_selectedIndex == 2)...[
                              VideoListScreen(),
                            ],
                    ...
                    Align(alignment: AlignmentDirectional.bottomCenter,child:                         ClipRect(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                ...
                                navigateTo(context, BookingDetailsView(isAdditionalFromSoeCiArea: widget.isAdditionalFromSoeCiArea,));
                              },
      ...
      builder: (context, state) {
        ...
        return InkWell(
          onTap: () {
            ...
            cubit.setSelectedBranchDoctorDetailsIndex(widget.index);
      ...
      builder: (context, state) {
        ...
        return GridView.builder(
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            ...
            childAspectRatio: 3.2, // Changed from 3 to 3.2
            crossAxisSpacing: 8, // Changed from 10 to 0
          ),
          itemCount: cubit.doctorDetailsModel!.branches!.length!,
          itemBuilder: (context, index) {
            return LocationItem(
              index: index,
              location: itArabic
                  ? cubit.detailsAreaNameArList[index]
                  : cubit.detailsAreaNameEnList[index],
              iconColor: cubit.doctorDetailsModel!.branches![index].status == "active"
                  ? HexColor('#246BFD')
                  : HexColor('#246BFD').withOpacity(.7),
              textColor: cubit.doctorDetailsModel!.branches![index].status == "active"
                  ? HexColor('#000000')
                  : HexColor('#000000').withOpacity(.7),
            );
          },
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SpecialtiesCubit, SpecialtiesState>(
      builder: (context, state) {
        ...
        return InkWell(
          onTap: () {
            cubit.setSelectedBranchDoctorDetailsId(
              cubit.doctorDetailsModel!.branches![widget.index].id,
            );
            cubit.setSelectedBranchDoctorDetailsIndex(widget.index);
            print(
                "Selected doctor details ID: ${cubit.doctorDetailsModel!.branches![widget.index].id}");
          },
          child: Container(
            alignment: AlignmentDirectional.center,
            decoration: BoxDecoration(
              color: cubit.selectedBranchDoctorDetailsId ==
                  cubit.doctorDetailsModel!.branches![widget.index].id
                  ? HexColor('#2563EB')
                  : Colors.transparent,
              borderRadius: BorderRadius.circular(12),
            ...
            child: Center(
              child: Row(
                ...
                mainAxisAlignment: MainAxisAlignment.center, // Centered the content
                children: [
                  SvgPicture.asset(
                    'assets/images/location_active.svg',
                  ...
                  Flexible(
                    child: Text(
                      ...
                      widget.location.tr(),
                      style: Theme.of(context).textTheme.headline5!.copyWith(
                        fontSize: itArabic ? 17 : 13, // Adjusted font sizes
                        fontFamily:
