            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  cubit.allReviewsModel!.itCanMakeReview ?
                  ClipRect(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              ...
                              showModalBottomSheet(
                                ...
                                builder: (context) => RatingBottomSheet(isFromDoctorRatingScreen: true , doctorIdFromDoctorRatingScreen:  cubit.allReviewsModel!.doctor!.id.toString()! ,appointmentIdFromDoctorRatingScreen: cubit.allReviewsModel!.doctor_appointment_id.toString()!, interPriseIdFromDoctorRatingScreen:cubit.doctorDetailsModel!.enterpriseId.toString()! ),
                                // فيه تغير هيحصل هنا
  ...
  Widget _buildReviewList(index){
    return BlocBuilder<SpecialtiesCubit, SpecialtiesState>(
      builder: (context, state) {
        ...
        var review = cubit.allReviewsModel!.reviews![index];
          ...
          if (!_voiceControllers.containsKey(index)) {
            controller = VoiceController(
              ...
              onPlaying: () {
                ...
                _currentlyPlayingController = _voiceControllers[index];
              }, maxDuration: Duration(minutes: 80),
            );
        ...
        return Column(
          ...
          children: [
            ...
            // Here i need the voice message will be network audio
            if (controller != null) ...[
              VoiceMessageView(
                ...
                circlesColor: HexColor('#2563EB'),
                activeSliderColor: HexColor('#2563EB'),
                innerPadding: 12,
                cornerRadius: 20,
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            showModalBottomSheet(
                              ...
                              builder: (context) => RatingBottomSheet(isFromDoctorRatingScreen: true , doctorIdFromDoctorRatingScreen:  cubit.allReviewsModel!.doctor!.id.toString()! ,appointmentIdFromDoctorRatingScreen: cubit.allReviewsModel!.doctor_appointment_id.toString()!, ),
                            );
                          },
                          style: ElevatedButton.styleFrom(
                            primary: Colors.transparent,
