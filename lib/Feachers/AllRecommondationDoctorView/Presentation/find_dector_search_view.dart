...
class AllRecomendationDoctorView extends StatefulWidget {
  @override
  State<AllRecomendationDoctorView> createState() => _AllRecomendationDoctorViewState();
}

class _AllRecomendationDoctorViewState extends State<AllRecomendationDoctorView> {
  ...
  void dispose() {
    SpecialtiesCubit
        ...
        SpecialtiesCubit
            .get(context)
            .searchOnTextSearchChangedRecofindDoctor);
    super.dispose();
  }
                              ...
                              children: [
                                if( cubit.isRecoSearchActivefindDoctor)...[
                                  cubit.searchRecoFilterModel == null
                                      ...
                                      itemBuilder: (context, index) {
                                        return DoctorCardDetailsSearch(
                                          ...
                                          name: context.locale.languageCode ==
                                              'ar'
                                              ? ' د.${cubit.searchRecoFilterModel!.data!
                                              .data![index]!.nameAr} ${cubit
                                              .searchRecoFilterModel!.data!.data![index]!
                                              .lastNameAr}'
                                              : 'Dr.${cubit.searchRecoFilterModel!.data!
                                      ...
                                      itemCount: cubit.searchRecoFilterModel!
                                          .data!.data!.length)
                                ],
                                      ...
                                      itemBuilder: (context, index) {
                                        return DoctorCardDetails(
                                          ...
                                          name: context.locale
                                              .languageCode ==
                                              'ar'
                                              ? ' د.${cubit.allRecomandationDoctorModel!
                                              .doctors![index]!.nameAr} ${cubit
                                              .allRecomandationDoctorModel!.doctors![index]!
                                              .lastNameAr}'
                                              : 'Dr.${cubit.allRecomandationDoctorModel!
                                          ...
                                          specialty: context.locale
                                              .languageCode ==
                                              'ar'
                                              ? '${cubit.allRecomandationDoctorModel!
                            ...
                            child: Container(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  if(cubit.recoSearchControlerfindDoctor.text.isNotEmpty){
                                    cubit.setIsRecoSearchActiveActivefindDoctor();
                                    cubit.fetchSearchDoctorsFilterRecoApi();
                                  }
