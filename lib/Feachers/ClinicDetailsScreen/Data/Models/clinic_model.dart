...
EnterpriseResponse enterpriseResponseFromJson(String str) =>
    EnterpriseResponse.fromJson(json.decode(str));
...
class EnterpriseResponse {
  ...
  factory EnterpriseResponse.fromJson(Map<String, dynamic> json) =>
      EnterpriseResponse(
        enterprise: Enterprise.fromJson(json['enterprise']),
        enterpriseSchedules: json['enterprise_schedules'] != null
            ? List<dynamic>.from(json['enterprise_schedules'])
            : [],
        locationFeatures: json['locationFeatures'] != null
            ? List<LocationFeature>.from(json['locationFeatures']
                .map((x) => LocationFeature.fromJson(x)))
            : [],
...
class Enterprise {
  ...
  factory Enterprise.fromJson(Map<String, dynamic> json) => Enterprise(
        ...
        cityId: json['city_id'] ?? 0,
        areaId: json['area_id'] ?? 0,
        locationFeatureIds: json['location_feature_ids'] != null
            ? List<dynamic>.from(json['location_feature_ids'])
            : [],
        logo: json['logo'] ?? '',
        specialMarkAr: json['special_mark_ar'] ?? '',
        specialMarkEn: json['special_mark_en'] ?? '',
        papersLicenses: json['papers_licenses'] != null
            ? List<dynamic>.from(jsonDecode(json['papers_licenses']))
            : [],
        location: json['location'] ?? '',
        tax: json['tax'] ?? '',
        registrationNo: json['registration_no'] ?? '',
        ...
        gallery: json['gallery'] != null
            ? List<dynamic>.from(jsonDecode(json['gallery']))
            : [],
        hasLab: json['has_lab'] == "true",
        hasRadiology: json['has_radiology'] == "true",
        year: json['year'] ?? '',
...
*/
  ...
  Branch({
    ...
    required this.nameAr,
    required this.nameEn,
    required this.gallery, // Added gallery field
/*
    required this.workingTime, // Added working_time field
*/
    ...
    required this.doctorsCount,
    required this.specializations,
    required this.workingTime, // Added workingTime field
  ...
  factory Branch.fromJson(Map<String, dynamic> json) => Branch(
    ...
    status: json['status'] ?? '',
        ...
        schedules: json['schedules'] != null
            ? List<dynamic>.from(json['schedules'])
            : [],
        city: City.fromJson(json['city'] ?? {}),
        area: Area.fromJson(json['area'] ?? {}),
        locationFeatures: json['locationFeatures'] != null
        ...
        // Parse gallery
/*        workingTime: json['working_time'] != null
            ? List<String>.from(json['working_time'])
            : [], // Parse working_time
      */);
}
...
class WorkingTime {
  ...
  // Method to convert WorkingTime to JSON (optional if you want to convert objects back to JSON)
...
class Doctor {
  ...
  factory Doctor.fromJson(Map<String, dynamic> json) => Doctor(
        ...
        serviceIds: json['service_ids'] != null
            ? List<dynamic>.from(json['service_ids'])
            : [],
        jobTitleAr: json['job_title_ar'] ?? '',
        jobTitleEn: json['job_title_en'] ?? '',
        additionalJobTitleAr: json['additional_job_title_ar'] ?? '',
        ...
        branchIds: json['branch_ids'] != null
            ? List<dynamic>.from(json['branch_ids'])
            : [],
        status: json['status'] ?? '',
        createdAt: DateTime.parse(
            json['created_at'] ?? DateTime.now().toIso8601String()),
...
class Review {
  ...
  factory Review.fromJson(Map<String, dynamic> json) => Review(
        ...
        userId: json['user_id'] ?? 0,
        rating:
            json['rating'] != null ? int.parse(json['rating'].toString()) : 0,
        comment: json['comment'] ?? '',
        status: json['status'] ?? '',
        createdAt: DateTime.parse(
            json['created_at'] ?? DateTime.now().toIso8601String()),
