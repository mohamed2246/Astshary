...
class ClinicDetailsView extends StatefulWidget {
  ...
  ClinicDetailsView({this.isAdditionalFromSoeCiArea = false});
...
class _ClinicDetailsViewState extends State<ClinicDetailsView> {
  ...
  Map<int, VoiceController> _voiceControllers = {};
  VoiceController? _currentlyPlayingController;

  @override
  void dispose() {
    // Dispose all voice controllers to prevent memory leaks
    _voiceControllers.values.forEach((controller) => controller.dispose());
    super.dispose();
  }
                                                        ...
                                                        Expanded(
                                                          child: StatItem(
                                                            ...
                                                            title: 'Specialties'
                                                                .tr(),
                                                            value:
                                                                '${cubit.countSpecialtiesList[cubit.selectedBranchIndex]}',
                                                          ),
                                                        ),
                                                        Expanded(
                                                          child: StatItem(
                                                            ...
                                                            title:
                                                                'Patients'.tr(),
                                                            value:
                                                                '${cubit.countPatientsList[cubit.selectedBranchIndex]}+',
                                                          ),
                                                        ),
                                                        Expanded(
                                                          child: StatItem(
                                                            ...
                                                            title:
                                                                'Doctors'.tr(),
                                                            value:
                                                                '${cubit.countDoctorsList[cubit.selectedBranchIndex]}',
                                                          ),
                                                        ),
                                                      ],
                                                    ),
                                            ...
                                            return ListView(
                                              ...
                                              children: [
                                                Column(
                                                  ...
                                                  children: [
                                                    cubit.aboutList[cubit.selectedBranchIndex].isNotEmpty?
                                                    Column(
                                                      children: [
                                                        Container(
                                                          width: double.infinity,
                                                    ...
                                                    cubit.listOfSpecialest[cubit.selectedBranchIndex].isNotEmpty ?
                                                        Column(
                                                          children: [
                                                            Container(
                                                                decoration:
                                                                  ...
                                                                  child: ExpansionTile(
                                                                    ...
                                                                    RoundedRectangleBorder(
                                                                      side: BorderSide(
                                                                        ...
                                                                        width:
                                                                        1, // Adjust the border width if needed
                                                                      ),
                                                                      borderRadius:
                                                                      BorderRadius
                                                                          .circular(
                                                                          4.0), // Adjust the border radius if needed
                                                                    ),
                                                                    children: <Widget>[
                                                                      Padding(
                                                                        padding:
                                                                        ...
                                                                        child: GridView
                                                                            .builder(
                                                                          itemCount: cubit.MakeClinicSpecializedList(
                                                                              isArabic:
                                                                              context.locale.languageCode == 'ar')
                                                                              .length,
                                                                          // Number of items
                                                                          shrinkWrap:
                                                                          true,
                                                                          // To fit the grid into the available layout
                                                                          physics:
                                                                          NeverScrollableScrollPhysics(),
                                                                          // To disable scrolling for GridView
                                                                          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                                                              ...
                                                                              childAspectRatio: MediaQuery.of(context).size.aspectRatio * 1.4 // Adjust this ratio based on the desired aspect ratio
                                                                          ),
                                                                          itemBuilder:
                                                                              (context,
                                                                              index) {
                                                                            return cubit.MakeClinicSpecializedList(
                                                                                isArabic:
                                                                                context.locale.languageCode ==
                                                                                    'ar')[index];
                                                                          },
                                                    ...
                                                    cubit.listOfInsurance[cubit.selectedBranchIndex].isNotEmpty ?
                                                    InsuranceTile() :SizedBox(),
                                                    cubit.listOfWorkingTime[cubit.selectedBranchIndex].isNotEmpty
                                                    ?WorkingTimeTile():SizedBox(),
                                                    cubit.listOfGalaries[cubit.selectedBranchIndex].isNotEmpty ?
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                          children: [
                                                            SizedBox(width: 27.w,),
                                                            Expanded(child: ClinicPhotosWidget()),
                                                          ],
                                                        ),
                                                      ],
                                                    ) : SizedBox(),
                                                      ...
                                                      itemBuilder:
                                                        ...
                                                        return DoctorCardDetails(
                                                          ...
                                                          isHalflove: double.parse(
                                                                  /*cubit.branchDoctorList![index]!.averageRating!*/
                                                                  "0") == 5
                                                              ? false
                                                              : true,
                                                        );
                                    ...
                                    child: Container(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () {
                                          ...
                                          navigateTo(
                                              context, BookingDetailsView(isAdditionalFromSoeCiArea: widget.isAdditionalFromSoeCiArea,));
                                          /*SpecialtiesCubit.get(context)
...
*/
  ...
  Widget _buildReviewList(index) {
    return BlocBuilder<SpecialtiesCubit, SpecialtiesState>(
      builder: (context, state) {
        var cubit = SpecialtiesCubit.get(context);
        var review = cubit.reviewsClinic!.reviews![index];
        VoiceController? controller;
        print('Review at index $index: ${review.toString()}');
        print('Review audio for index $index is: ${review.audio}');
        // Check if the review has an audio file
        if (review.audio != null && review.audio!.isNotEmpty) {
          // Ensure the controller is created
          if (!_voiceControllers.containsKey(index)) {
            controller = VoiceController(
              audioSrc: review.audio!,
              isFile: false, // Since it's network audio
              onComplete: () {
                if (_currentlyPlayingController == _voiceControllers[index]) {
                  _currentlyPlayingController = null;
                }
              },
              onPause: () {},
              onPlaying: () {
                // Pause any other controller that is currently playing
                if (_currentlyPlayingController != null &&
                    _currentlyPlayingController != _voiceControllers[index]) {
                  _currentlyPlayingController!.pausePlaying();
                }
                _currentlyPlayingController = _voiceControllers[index];
              }, maxDuration: Duration(minutes: 1204),
            );
            _voiceControllers[index] = controller;
          } else {
            controller = _voiceControllers[index]!;
          }
        }
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            if (controller != null) ...[
              VoiceMessageView(
                ...
                counterTextStyle: Theme.of(context).textTheme.bodyText2!.copyWith(
                  color: HexColor('#000000'),
                  fontFamily: 'Inter-Medium',
                  fontSize: 13.sp,
                  fontWeight: FontWeight.w500,
                ),
                circlesTextStyle: Theme.of(context).textTheme.bodyText2!.copyWith(
                  color: Colors.white,
                  fontFamily: 'Inter-Medium',
                  fontSize: 13.sp,
                  fontWeight: FontWeight.w500,
                ),
                circlesColor: receiverTextColor, // Replace with your actual color
                activeSliderColor: receiverTextColor, // Replace with your actual color
                innerPadding: 12,
                cornerRadius: 20,
                backgroundColor: buttomColor, // Replace with your actual color
              ),
            ...
            Row(
              ...
              children: [
                Container(  width: 14 , height: 14,child: SvgPicture.asset('assets/images/stethoscope.svg' , width: 14 , height: 14)),
                SizedBox(width: 4.w,),
                ...
                Flexible(
                  child: Text(
                    ...
                    maxLines: 1,
                    itArabic ? 'د/ ${cubit.reviewsClinic!.reviews![index].doctor_name_ar!}' :'Dr/ ${cubit.reviewsClinic!.reviews![index].doctor_name_en!}',
                    style: Theme.of(context).textTheme.headline5!.copyWith(
                        fontSize: itArabic ? 12 : 10,
                        fontWeight: FontWeight.w400,
                        fontFamily: itArabic ? 'Somar-Bold' : 'Gilroy-Bold',
                        color: HexColor('#23262F')),
                  ),
            ...
            Divider(color: HexColor('#E9E9EA').withOpacity(.60), thickness: 1),
          ],
        );
      },
    );
          ...
          Row(
            ...
            children: [
              SvgPicture.asset(
                ...
                width: iconPath == 'assets/images/users-group.svg' ? 16 : 20,

                color: title == 'Patients'.tr()
                    ? HexColor('#FFFFFF')
                    : HexColor('#3F76EE'), // Adjust the size as needed
              ),
              SizedBox(
    ...
    return InkWell(
      onTap: () {
        SpecialtiesCubit.get(context).selectedDoctorIdDetails =
            SpecialtiesCubit.get(context).branchDoctorList![widget.index]!.id!;
                            ...
                            children: <Widget>[
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  SpecialtiesCubit.get(context).branchDoctorList![widget.index].isVip == "1" ?
                                  Row(
                                    children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      context.locale.languageCode == 'ar'
                                          ? '${SpecialtiesCubit.get(context).clinicNameAr}'
                                          : '${SpecialtiesCubit.get(context).clinicNameEn}}',
                                      maxLines: 2,
                                      // Set a maxLines to avoid unlimited expansion
                                      overflow: TextOverflow.ellipsis,
                                      style: Theme.of(context)
                                  ...
                                  SpecialtiesCubit.get(context).branchDoctorList![widget.index].isIntegratedClinic! ?
                                  Container(
                                    decoration: BoxDecoration(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                              ...
                              maxLines: 2,
                              context.locale.languageCode == 'ar'
                                  ? '${SpecialtiesCubit.get(context).branchDoctorList![index]!.specializations![0].nameAr}'
                                  : '${SpecialtiesCubit.get(context).branchDoctorList![index]!.specializations![0].nameEn}',
                              style: textStyle),
                        ],
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                              ...
                              maxLines: 2,
                              context.locale.languageCode == 'ar'
                                  ? '${SpecialtiesCubit.get(context).branchDoctorList![index].areas![0].nameAr}'
                                  : '${SpecialtiesCubit.get(context).branchDoctorList![index].areas![0].nameEn}',
                              style: textStyle),
                        ],
                      ),
                    ),
...
*/
                            text: SpecialtiesCubit.get(context)
                                ...
                                : '${itArabic ? translateDayToArabicAbbreviation(SpecialtiesCubit.get(context).branchDoctorList![index].avaliableAppointments![0]!.day!) : translateDayToEnglishAbbreviation(SpecialtiesCubit.get(context).branchDoctorList![index].avaliableAppointments![0]!.day!)} ' // Day abbreviation
                                    '${getDayFromDate(SpecialtiesCubit.get(context).branchDoctorList![index].avaliableAppointments![0]!.date!)} ' // Extract day from date
                                    '${itArabic ? translateMonthToArabic(getMonthFromDate(SpecialtiesCubit.get(context).branchDoctorList![index].avaliableAppointments![0]!.date!)) : translateMonthToEnglish(getMonthFromDate(SpecialtiesCubit.get(context).branchDoctorList![index].avaliableAppointments![0]!.date!))} ' // Month
                                    '${formatTime(SpecialtiesCubit.get(context).branchDoctorList![index].avaliableAppointments![0]!.time!, itArabic)}',
...
class WorkingTimeTile extends StatefulWidget {
  @override
  _WorkingTimeTileState createState() => _WorkingTimeTileState();
}

class _WorkingTimeTileState extends State<WorkingTimeTile> {
  bool insuranceOpen = false;
                ...
                Padding(
                  ...
                  child: SizedBox(
                      child: ListView.separated(
                          ...
                          physics: NeverScrollableScrollPhysics(),
                          itemBuilder: (context, index) {
                            var listOfworkingTime =
                                cubit.listOfWorkingTime[cubit.selectedBranchIndex];
                          ...
                          itemCount: cubit
                              .listOfWorkingTime[cubit.selectedBranchIndex]
                              .length)),
                ),
              ],
            ),
...
String formatTime2(String time, bool isArabic) {
  try {
    // Trim any leading/trailing whitespace
    time = time.trim();

    // Split the time string (HH:mm:ss) into its components
    ...
    hour = hour % 12;
    if (hour == 0) {
      hour = 12; // Midnight and Noon edge case
    }

    // Return formatted time (h:mm AM/PM or ص/م)
...
class WorkingTimeItem extends StatelessWidget {
  ...
  WorkingTimeItem(this.workingTime);

  @override
  Widget build(BuildContext context) {
    // Detect locale to check if it's Arabic or English
    bool isArabic = Localizations.localeOf(context).languageCode == 'ar';

    // Translate day based on the locale
    String day = isArabic
        ? workingTime.day // Display Arabic day if Arabic locale is active
        : translateDayToEnglish(workingTime.day); // Translate day to English if locale is not Arabic

    // Format start_time and end_time as string manually
    String startTime = formatTime2(workingTime.start_time, itArabic);
    String endTime = formatTime2(workingTime.end_time , itArabic);

    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        SvgPicture.asset(
          'assets/images/spring-calendar.svg',
          width: 14.w,
          height: 14.h,
        ),
        SizedBox(
        ...
        Column(
          ...
          children: [
            ...
            Text(
              '$day  |  $startTime - $endTime', // Formatted day and time string
              style: Theme.of(context).textTheme.headline5!.copyWith(
                fontSize: isArabic ? 16.sp : 12.sp,
                fontWeight: FontWeight.w400,
                fontFamily: isArabic ? 'Somar-Bold' : 'Gilroy-Bold',
                color: HexColor('#4F5159'),
              ),
            ),
          ],
      ...
      builder: (context, state) {
        ...
        return Container(
          ...
          child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                var listOfImages =
                    cubit.listOfGalaries[cubit.selectedBranchIndex];
                ...
                return Container(
                  ...
                  child: Image.network(
                    cubit.listOfGalaries[cubit.selectedBranchIndex][index], // Make sure this returns a valid string
                    height: 76.h,
                    width: 76.w,
                    fit: BoxFit.fill,
                  ),
              ...
              itemCount: cubit.listOfGalaries[cubit.selectedBranchIndex].length),
        );
      },
    );
  }
