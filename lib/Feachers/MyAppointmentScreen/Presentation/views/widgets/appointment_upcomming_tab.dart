...
class AppointmentUpcommingTab extends StatefulWidget {
  const AppointmentUpcommingTab({Key? key}) : super(key: key);

  @override
  State<AppointmentUpcommingTab> createState() =>
      _AppointmentUpcommingTabState();
}

class _AppointmentUpcommingTabState extends State<AppointmentUpcommingTab> {
  bool isLoading = true;
      ...
      builder: (context, state) {
        ...
        return Container(
          ...
          cubit.isMyAppointmentsRecervationsLoading
              ...
              : cubit.appointmentRecervations!.upcoming.isEmpty
                  ? Container(
                      width: double.infinity,
                      height: double.infinity,
                      child: Column(
                              ...
                              child: RefreshIndicator(
                                ...
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (BuildContext context, int index) {
                                    if (index == 0) {
                                      return Column(
                                        children: [
                                          ...
                                          BookingAppointmentCard(false,
                                              appointment: cubit
                                                  .appointmentRecervations!
                                                  .upcoming[index]),
                                        ],
                                      );
                                    }
                                    if (index ==
                                        cubit.appointmentRecervations!.upcoming
                                                .length -
                                            1) {
                                      return Column(
                                        children: [
                                    ...
                                    return BookingAppointmentCard(false,
                                        appointment: cubit
                                            .appointmentRecervations!
                                            .upcoming[index]);
                                  },
                                  itemCount: cubit
                                      .appointmentRecervations!.upcoming.length,
                                ),
                              ),
                            ),
                          ),
...
// this si the case of there are no appoint ment in this list
