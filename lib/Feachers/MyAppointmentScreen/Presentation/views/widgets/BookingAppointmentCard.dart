...
class BookingAppointmentCard extends StatelessWidget {
  ...
  BookingAppointmentCard(this.completeOrCancle,
      {this.isCancle = false, this.appointment , this.isUpComming = false});
                            ...
                            Text(
                              ...
                              style: Theme.of(context)
                                  ...
                                  .copyWith(
                                      ...
                                      fontWeight: FontWeight.w400,
                                      color:
                                          HexColor('#7B7D82').withOpacity(.80)),
                            ),
                          ],
                        ),
                      ),
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              isCancle!
                                ...
                                children: [
                                  Text(
                                      '${formatDate(appointment!.doctorAppointment.date, itArabic)}  |   ',
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyText2!
                                          .copyWith(
                                  ...
                                  Expanded(
                                    child: Text(
                                        '${appointment!.doctorAppointment.time == null ? formatTime(appointment!.doctorAppointment.from, itArabic) + '\n' + formatTime(appointment!.doctorAppointment.to, itArabic) : formatTime(appointment!.doctorAppointment.time, itArabic)}'
                                            .tr(),
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyText2!
                                  ...
                                  : Text(
                                  formatDate(
                                      appointment!.doctorAppointment.date,
                                      itArabic),
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodyText2!
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                  isCancle!
                                      ? ''
                                      : appointment!.doctorAppointment.time ==
                                      null
                                      ? formatTime(
                                      appointment!
                                          .doctorAppointment.from,
                                      itArabic) +
                                      ' : ' +
                                      formatTime(
                                          appointment!
                                              .doctorAppointment.to,
                                          itArabic)
                                      : formatTime(
                                      appointment!
                        ...
                        Expanded(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              if (completeOrCancle) {
                                print(
                                    "old Appointment is ${appointment!.id.toString()}");
                                print(
                                    " appointment!.doctorAppointment.doctorId ${appointment!.doctorAppointment.doctorId.toString()}");
                                ...
                                cubit.doctorRescadualId =
                                    appointment!.doctorAppointment.doctorId;
                                cubit.interPriseRescadualId =
                                    appointment!.doctorAppointment.enterpriseId;
                                cubit.fetchMyAppointment(
                                    isRecadual: true,
                                    doctorRescadualId:
                                    appointment!.doctorAppointment.doctorId,
                                    interPriseRescadualId: appointment!
                                        .doctorAppointment.enterpriseId);
/*
                            cubit.RescadaulAppointmentRecervations( doctor_appointment_id: appointment!.id.toString());
*/
                              } else {
                                cubit.cancleAppointmentRecervations(
                                    appointment!.id);
                              }
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              backgroundColor: HexColor(
                                  completeOrCancle ? '#2563EB' : '#E53935'),
                ...
                Expanded(
                  child: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 16.w), // Adjust padding as needed
                    child: Container(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  itArabic ?'${appointment!.address_ar}' :'${appointment!.address_en}' ,
                                  style: Theme.of(context).textTheme.bodyText2!.copyWith(
                                    fontSize: itArabic ? 16 : 12,
                                    color: HexColor('#7B7D82'),
                                    height: 1.8,
                              ...
                              appointment!.location == null ? SizedBox():
                              InkWell(
                                onTap: (){
                                  _launchURL(appointment!.location);
                                },
                                child: SvgPicture.asset(
                                  'assets/images/map_image.svg',
                                  height: 19.h,
                                  width: 18.w,
                                ),
                              ),
