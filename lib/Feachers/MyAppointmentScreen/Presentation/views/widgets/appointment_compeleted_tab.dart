...
class AppointmentCompletedTab extends StatefulWidget {
  const AppointmentCompletedTab({Key? key}) : super(key: key);
      ...
      builder: (context, state) {
        ...
        return Container(
            ...
            cubit.isMyAppointmentsRecervationsLoading
                ...
                : cubit.appointmentRecervations!.current.isEmpty
                    ? Container(
                        width: double.infinity,
                        height: double.infinity,
                        child: Column(
                                ...
                                child: RefreshIndicator(
                                  ...
                                  child: ListView.separated(
                                    ...
                                    itemBuilder:
                                      ...
                                      if (index ==
                                          cubit.appointmentRecervations!.current
                                                  .length -
                                              1) {
                                        return Column(
                                          children: [
                                      ...
                                      return BookingAppointmentCard(true,
                                          appointment: cubit
                                              .appointmentRecervations!
                                              .current[index]);
                                    },
                                    itemCount: cubit
                                        .appointmentRecervations!.current.length,
                                  ),
                                ),
                              ),
                            ),
