                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ProfileCustomAppBar(
                                imageUrl:SpecialtiesCubit.get(context).successResponse!.patient!.image ??'assets/images/profile_image.png',
                                settings: false,
                                profile_hint:    SpecialtiesCubit.get(context).successResponse!.patient!.phone!,
                                profile_name:SpecialtiesCubit.get(context).successResponse!.patient!.name!,
                            ),
                            Padding(
                              padding:
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SettingsItem(
                                      icon: 'assets/images/profile_settings.svg',
                                      text: 'Profile'.tr()),
                                  SizedBox(
                                    height:
                                          ...
                                          child: InkWell(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Spacer(),
                                                RotatedBox(
                                                  quarterTurns: itArabic ? 2 : 0,
                                                  child: CustomSwitch(
                                                    height: 16,
                                                    width: 31,
                                                    value: cubit.switchValue1,
                                                    switchHeight: 15,
                                                    switchWidth: 15,
                                                    enableColor:
                                                        HexColor('#DBEAFE'),
                                                    disableColor:
                                                        HexColor('#DBEAFE'),
                                                    onChanged: (value) {
                                                      cubit.toggleswitchValuesetValue(value);
                                                      cubit.postNotificationOnOfApi(value);
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                        ...
                                        svgIconUrl:
                                            'assets/images/akar-icons_twitter-fill.svg', link:  cubit.getLinkByName('twitter')!,
                                      )),
                                      Expanded(
                                          child: SosialMediaItem(
                                            link: cubit.getLinkByName('facebook')!,
                                              svgIconUrl:
                                                  'assets/images/face.svg')),
                                      Expanded(
                                          child: SosialMediaItem(
                                              link: cubit.getLinkByName('tiktok')!,

                                              svgIconUrl:
                                                  'assets/images/bx_bxl-tiktok.svg')),
                                      Expanded(
                                          child: SosialMediaItem(
                                            link: cubit.getLinkByName('instagram')!,

                                            svgIconUrl: 'assets/images/insta (2).svg',
                                      )),
                                    ],
                                  ),
                                  SizedBox(
